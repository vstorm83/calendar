...
public abstract class TestRestApi extends AbstractResourceTest {
  ...
  public void setUp() throws Exception {
    ...
    groupCalendar = this.createGroupCalendarWithEditPermission("group-calendar", Arrays.asList("/platform/administrators", "/platform/users"), "/platform/administrators/:root");
